			...
			<section class="property" id ="property">
				...
				<div class="container"> 
					...
					<div class="property-card">
							...
							<figure>
								<a href="./Assets/Properties/Kaylaprime.html"><img src="./Assets/Images/Alexandria/Alexandria Exterior.png"/ alt="Sample cards"> </a>
							</figure>
							<h2 class="h3 property-name"> Alexandria </h2>
							<ul class="property-list">
								<li>
									<div class="property-item">
										<!-- PRICE HERE -->
										<i class="fa-solid fa-hand-holding-dollar"></i>
										<span>5,720,410.00</span>
									</div>
								</li>		
							...
							<div class="property-card-item">
							<figure>
								<img src="./Assets/Images/Amara Expanded/Amara Exterior.png" alt="Img 1"> 
							</figure>
							<h2 class="h3 property-name"> Amara Expanded </h2>
							<ul class="property-list">
								<li>
									<div class="property-item">
										<!-- PRICE HERE -->
										<i class="fa-solid fa-hand-holding-dollar"></i>
										<span>5,962,300.00</span>
									</div>
								</li>		
							...
							<div class="property-card-item">
							<figure>
								<img src="./Assets/Images/Arya Prime/Arya Exterior.png" alt="Arya Exterior image"> 
							</figure>
							<h2 class="h3 property-name"> Arya Prime </h2>
							<ul class="property-list">
								<li>
									<div class="property-item">
										<!-- PRICE HERE -->
										<i class="fa-solid fa-hand-holding-dollar"></i>
										<span>8,261,110.00</span>
									</div>
								</li>		
							...
							<div class="property-card-item kayla">
							<figure>
								<img src="./Assets/Images/Kayla Prime/Kayla Prime.png" alt="Kayla Prime"> 
							</figure>
							<h2 class="h3 property-name"> Kayla Prime</h2>
							<ul class="property-list">
								<li>
									<div class="property-item">
										<!-- PRICE HERE -->
										<i class="fa-solid fa-hand-holding-dollar"></i>
										<span>10,200,220.00</span>
									</div>
								</li>		
